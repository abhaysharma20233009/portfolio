...
function App() {
 ...
 <video
  ...
  <h1 className='absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-shadow text-fuchsia-600 font-bold italic tracking-wide leading-relaxed z-20'>Welcome To my Portfolio</h1>

...
function App() {
 ...
 <video
  ...
  <h1 className='absolute text-center text-shadow text-blue-950 bg-neutral-600 font-bold italic tracking-wide leading-relaxed z-20'>Welcome To my Portfolio</h1>
